...
void handler_channel_1(void) {
  ...
  if (channel_select_counter == 1)channel_4 = measured_time;
  if (channel_select_counter == 2)channel_3 = measured_time;
  if (channel_select_counter == 3)channel_1 = measured_time;
  if (channel_select_counter == 4)channel_2 = measured_time;
  if (channel_select_counter == 5)channel_5 = measured_time;
  if (channel_select_counter == 6)channel_6 = measured_time;
  //Serial.print(channel_4);Serial.print(channel_3);Serial.print(channel_1);Serial.print(channel_2);Serial.print(channel_5);Serial.println(channel_6);
}
